...
static void Handle_Command(char* str){
    ...
    //check command
    if(strstr(buffer, "Consecutive") != NULL){
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
    ...
    CalculateThresholds(CLENCHED_VOLTAGE, RESTING_VOLTAGE);
